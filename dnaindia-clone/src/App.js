    ...
    <VStack backgroundColor="#f5f5f5" textColor="black">
      ...
      <Flex w="90%" direction={{ base: "column", md: "column", lg: "row" }}>
        ...
        >
          ...
          <Link
            href="https://www.ezmall.com/?utm_source=Dnaindia.com&utm_medium=Affiliate&utm_campaign=Dnaindia.com_Traffic"
            _hover={{
              textDecoration: "none",
            }}
            isExternal
          >
            <Flex
              ...
              // border="1px solid red"
            >
              <Image src="https://english.cdn.zeenews.com/static/public/icons/ezmall-icon1.png" />
              <Text textDecoration="none">Ezmall</Text>
            </Flex>
          </Link>
        </VStack>
        <VStack
