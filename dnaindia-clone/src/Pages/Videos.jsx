    ...
    return(
        <VStack backgroundColor="#f5f5f5" marginBottom="20px" width="100%">
            ...
            <VStack backgroundColor="#f5f5f5" marginBottom="20px" width="100%">
                ...
                <Box w="100%"  borderBottom="1px solid #e2e2e2" align="left" marginTop="30px" marginBottom="40px" position="relative">
                ...
                <VStack width="100%" backgroundColor="black">
                    {
                        home?.map((item,ind)=>{
                            return <VStack key={ind} backgroundColor="black" width="100%" position="relative" marginBottom="15px" borderBottom="1px solid white">
