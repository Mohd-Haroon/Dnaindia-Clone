...
import {getiNDIAdata} from "../redux/actions"
...
export const India=()=>{
    const {india,loading} = useSelector((store)=>store.news)
    ...
    return(
        <VStack backgroundColor="#f5f5f5" marginBottom="20px" width="100%">
            ...
            <VStack backgroundColor="#f5f5f5" marginBottom="20px" width="100%">
                ...
                <FeedVideoSlider data={india?.slice(0, 8)}/> 
                {
                india?.slice(24, india.length-1)?.map((item,ind)=>{
                    return <Flex backgroundColor="#fff" padding="10px" borderRadius="5px" marginBottom="10px" key={ind}>
                    <Box maxWidth="25%" marginRight="10px">
